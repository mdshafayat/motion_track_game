...
while (nFrames<1500)  % Stop when end of file is reached  
    ...
    pause(0.1);
    keyboard.keyRelease(KeyEvent.VK_P);
    fprintf('P')
    ...
    if ind>0
        ...
        diff2=avg_cn(2)- pre_cn(2)
        
        if (abs(diff)>=10 && abs(diff2)>=10)
           if  diff>0
               if diff2>0
                   keyboard.keyPress(KeyEvent.VK_PERIOD); 
                   pause(0.1);
                   keyboard.keyRelease(KeyEvent.VK_PERIOD);
    %              inputemu('key_normal',',');
                    fprintf('L')
               else
...
%                 inputemu('key_normal',':');
        ...
        elseif abs(diff2)>=10
             if  diff2>0 
                ...
                pause(0.1);
                keyboard.keyRelease(KeyEvent.VK_SEMICOLON);
%                 inputemu('key_normal',',');
                fprintf('L')
                ...
                pause(0.1);
                keyboard.keyRelease(KeyEvent.VK_COMMA);
%                 inputemu('key_normal',':');
                fprintf('K');
            end 
...
%             fprintf('heavy punch')
                ...
                pause(0.1);
                keyboard.keyRelease(KeyEvent.VK_O);
                fprintf('O');
